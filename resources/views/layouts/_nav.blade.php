<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{route('welcome')}}">Onlinemo<span class="text-primary font-weight-bold">vies</span></a>
                ...
                @auth
                    <li class="nav-item mr-2">
                        <a href="{{route('movies.index',['favorite'=>1])}}" class="nav-link text-white"style="position: relative";>
                            ...
                            style="position: absolute;top: 0px;right: -15px;width: 30px;height: 20px;border-radius: 50px"
                                  id="nav__fav-count"
