@extends('layouts.dashboard.app',['title'=>'Edit Movie'])
@section('content')
    <h2>Edit movies</h2>
        <ul class="breadcrumb">
        ...
        <div class="tile mb-4">
            ...
            >
                ...
                <div class="form-group">
                    ...
                    <img src="{{$movie->image_path}}" style="width: 300px; height:308px;margin-top: 10px">
                ...
                <div class="form-group">
                    <button type="submit" id="movie__submit-btn"  class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button>
                </div>
